...
<html>
    ...
    <body >
        ...
        <form id="addform" class="forms" enctype='multipart/form-data'>
            ...
            <div align='center'>
                ...
                <button type="button" id="addproduct" onclick="addProduct()">Add Product</button>
                <button type="button" id="clear" onclick="clearForm('addform')">Clear</button>
            </div>
        </form>
        <form id='updateform' class="forms" enctype='multipart/form-data'>
